    ...
    <>
      ...
      <section className="events-section" style={{ paddingTop: 0 }}>
        <div className="section-heading" style={{ textAlign: "center", margin: "0 auto 44px" }}>
          ...
          <p style={{ marginTop: 8 }}>To let us know you&apos;re attending, text us at <a href="sms:+15182572335" style={{ fontWeight: 600, color: "inherit", textDecoration: "underline" }}>(518) 257-2335</a>.</p>
        </div>
