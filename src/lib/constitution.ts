// Verbatim text of the Faith Bible Church Constitution, migrated from
// fbcministriesny.org/fbc-constitution. Rendered by /about/constitution.
// Headings are lines like "ARTICLE I - NAME" / "SECTION A: ..."; the page
// component classifies them — keep this as plain text, edit wording freely.

export const constitution = `PREAMBLE
